...
z = 0.
cosmo = Class ()
cosmo.set({'k_pivot':'0.05','A_s':'2.226721791551475e-9','n_s':'1.','alpha_s':'0.','Omega_k':'0.','Omega_fld':'0','YHe':0.25,'z_reio':'10.','T_cmb':'2.726','h':'0.7','omega_b':'0.0196','N_ncdm':'0','N_eff':'3.04','omega_cdm':'0.1029','P_k_max_h/Mpc': '100.','output':'mPk,tCl','z_pk':z,'non linear':' SPT ','IR resummation':' Yes ','Bias tracers':' Yes ','RSD':' Yes ','RSD only':'No', 'AP':'No','SigmaFOG':'0.'})
