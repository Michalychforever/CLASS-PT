...
(* ::Input:: *)
(*vv2\[ScriptF][2][n1,n2]/vv0\[ScriptF][2][n1,n2]*)


(* ::Input:: *)
(*FullSimplify[vv2\[ScriptF][3][n1,n2]/vv0\[ScriptF][3][n1,n2]]*)


(* ::Input:: *)
(*(* not worth to investigate here, since we do NOT care about the multipoles WITHOUT IR resummation... If there are simplifications at the level of powers of \[Mu], that will be great... But it would be great to find a systematic way to check the ratios... *)*)
...
(* ::Input:: *)
(*dd2\[ScriptF][1][n1,n2]/dd0\[ScriptF][1][n1,n2]*)
