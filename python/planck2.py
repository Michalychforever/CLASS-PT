...
cosmo = Class ()
cosmo.set({'k_pivot':'0.05','ln10^{10}A_s':'3.21579','n_s':'0.9649','alpha_s':'0.','Omega_k':'0.','Omega_fld':'0','YHe':0.25,'z_reio':'10.','T_cmb':'2.726','h':'0.6517820','omega_b':'0.0211213','N_ncdm':'0','N_eff':'3.045','omega_cdm':'0.113324','P_k_max_h/Mpc': '100.','output':'mPk,tCl','z_pk':'0.61','non linear':' SPT ','IR resummation':' Yes ','Bias tracers':' Yes ','RSD':' Yes ','RSD only':'No', 'Alcock-Paczynski effect':'Yes'})
t1 = time()
cosmo.compute() 
...
np.savetxt('jap2_pk_nl.dat', testout)
t2 = time()
